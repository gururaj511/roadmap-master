...
var consumer =
  new OAuth("https://pinguintest.atlassian.com/plugins/servlet/oauth/request-token",
    "https://pinguintest.atlassian.com/plugins/servlet/oauth/access-token",
    config["consumerKey"],
    "",
    "1.0",
  ...
  consumer.getOAuthRequestToken(
    function(error, oauthToken, oauthTokenSecret, results) {
      if (error) {
        ...
        response.redirect("https://pinguintest.atlassian.com/plugins/servlet/oauth/authorize?oauth_token="+request.session.oauthRequestToken);
      }
    }
  )
});
  ...
  consumer.getOAuthAccessToken (
    ...
    function(error, oauthAccessToken, oauthAccessTokenSecret, results){
      if (error) {
        ...
        consumer.get("https://pinguintest.atlassian.com/rest/api/latest/issue/JRADEV-8110.json",
